...
public class Sound2NoteService {
    ...
    public Note convert (final String fileName, final Sound [] channels)
            throws SoundTransformException {
        return this.convert (fileName, channels,
                this.frequencyHelper.findFrequency (channels [0]));
    }
    ...
    public Note convert (final String fileName, final Sound [] channels,
        ...
        return new SimpleNote (fileName, channels, frequency, attack, decay,
                sustain, release);
