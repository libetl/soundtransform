...
public class AddNoteService extends AbstractLogAware<AddNoteService> {
    ...
    public AddNoteService (final Sound2NoteService sound2NoteService1, final InputStreamToSoundService inputStreamToSoundService1, final AudioFileService convertAudioFileService1, final AudioFileHelper audioFileHelper1, final AudioFormatParser audioFormatParser1, final Observer... observers1) {
