...
public interface FrameProcessor<T> extends LogAware<T> {
    ...
    public enum FrameProcessorEventCode implements EventCode {
        ...
        READ_END (LogLevel.INFO, "Finished reading the input stream"), SOUND_INIT (LogLevel.INFO, "Converted sound allocation in memory"), READ_FRAME_SIZE (LogLevel.PARANOIAC, "Read frame size : %1d");
        ;
