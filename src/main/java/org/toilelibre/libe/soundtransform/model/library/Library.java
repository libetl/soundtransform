    ...
    public Pack                     defaultPack = new Pack () {
...

        {
            this.put ("simple_piano", new Range () {
                {
                    AddNoteService.addNotes (this, "Piano1-C.wav", "Piano3-E.wav", "Piano5-G.wav", "Piano7-B.wav",
                            "Piano2-D.wav", "Piano4-F.wav", "Piano6-A.wav", "Piano8-C.wav");
                }
            });
            this.put ("g-piano", new Range () {
                {
                    AddNoteService.addNotes (this, "g-piano1.wav", "g-piano2.wav", "g-piano3.wav", "g-piano4.wav",
