...
final class DefaultAudioFileService extends AbstractLogAware<DefaultAudioFileService> implements AudioFileService<AbstractLogAware<DefaultAudioFileService>> {
    ...
    /* (non-Javadoc)
     * @see org.toilelibre.libe.soundtransform.model.inputstream.AudioFIleService#streamFromFile(java.io.File)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.toilelibre.libe.soundtransform.model.inputstream.AudioFIleService#streamFromRawStream(java.io.InputStream, org.toilelibre.libe.soundtransform.model.inputstream.StreamInfo)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.toilelibre.libe.soundtransform.model.inputstream.AudioFIleService#fileFromStream(java.io.InputStream, java.io.File)
     */
    @Override
