...
public class MagnitudeADSRHelper extends AbstractLogAware<MagnitudeADSRHelper> implements ADSRHelper {
    ...
    public int findDecay (final Sound channel1, final int attack) throws SoundTransformException {
        ...
        final double [] magnitude = this.getMagnitudeArray (channel1, MagnitudeADSRHelper.ACCURATE_STEP_FOR_ADSR_HELPER);
    ...
    public int findRelease (final Sound channel1) throws SoundTransformException {
        ...
        final double [] magnitude = this.getMagnitudeArray (reversed, MagnitudeADSRHelper.ACCURATE_STEP_FOR_ADSR_HELPER);
    ...
    private double [] getMagnitudeArray (final Sound sound, final int step) {
