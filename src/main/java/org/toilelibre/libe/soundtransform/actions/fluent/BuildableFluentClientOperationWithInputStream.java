...
public interface BuildableFluentClientOperationWithInputStream extends FluentClientWithInputStream, BuildableFluentClientOperation {
     ...
     */
    @Override
    BuildableFluentClientOperationWithInputStream playIt (Object stopMonitor) throws SoundTransformException;
     ...
     */
    @Override
    BuildableFluentClientOperationWithInputStream playIt (Object stopMonitor, int skipMilliSeconds) throws SoundTransformException;
