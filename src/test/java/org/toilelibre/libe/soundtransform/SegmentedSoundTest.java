...
public class SegmentedSoundTest {
    ...
    public void setSampleAtWorksAsUsual () throws SoundTransformException{
        new SegmentedSound (new FormatInfo (2, 11025), Arrays.asList (
                FluentClient.start ().withClasspathResource ("piano1c.wav").convertIntoSound ().stopWithSound (), 
                FluentClient.start ().withClasspathResource ("piano2d.wav").convertIntoSound ().stopWithSound ())).getChannels () [0].setSampleAt (0, 329);
    ...
    public void getSampleAtWorksAsUsual () throws SoundTransformException{
        new SegmentedSound (new FormatInfo (2, 11025), Arrays.asList (
                FluentClient.start ().withClasspathResource ("piano1c.wav").convertIntoSound ().stopWithSound (), 
                FluentClient.start ().withClasspathResource ("piano2d.wav").convertIntoSound ().stopWithSound ())).getChannels () [0].getSampleAt (0);
    ...
    public void aSegmentedSoundCopyOfAPartReturnsTheCorrectPart () throws SoundTransformException {
        ...
        long [] sound12array = new long [sound1.getSamplesLength ()];
        Sound sound12Bis = new Sound (new Channel [] {new Channel (sound12array, sound1.getFormatInfo (), 0)});
