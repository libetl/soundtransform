...
public class ShapeTest {
	...
	public void testShapeASimplePianoNoteAsAChordNote () throws SoundTransformException {
		...
		try {
			...
			final InputStream outputStream = new TransformSoundService (new PrintlnTransformObserver ()).transformAudioStream (new ConvertAudioFileService ().callConverter (input),
			        new ShapeSoundTransformation (Library.defaultPack, "chord_piano"));
