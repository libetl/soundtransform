...
public class WavTest {
    ...
    private final File        output      = new File (
                                                  new File (this.classLoader
                                                          .getResource (
                                                                  "before.wav")
                                                          .getFile ())
                                                          .getParent ()
    ...
    public void test8bits () throws SoundTransformException {
        $.create (TransformSoundService.class, new PrintlnTransformObserver ())
                .transformFile (this.input, this.output,
    ...
    public void testFreqNoOp () throws SoundTransformException {
        $.create (TransformSoundService.class, new PrintlnTransformObserver ())
                .transformFile (this.input, this.output,
                        $.create (SimpleFrequencySoundTransformation.class));
    ...
    public void testPitch () throws SoundTransformException {
        $.create (TransformSoundService.class, new PrintlnTransformObserver ())
                .transformFile (this.input, this.output,
                        new PitchSoundTransformation (100));
    ...
    public void testPurify () throws SoundTransformException {
        ...
        $.create (TransformSoundService.class, new PrintlnTransformObserver ())
                .transformFile (this.input, this.output,
                        $.create (PurifySoundTransformation.class));
    ...
    public void testRemoveLowFreqs () throws SoundTransformException {
        $.create (TransformSoundService.class, new PrintlnTransformObserver ())
                .transformFile (
                        this.input,
                        this.output,
                        $.create (EqualizerSoundTransformation.class,
                                new double [] { 0, 2000, 4000, 6000, 8000,
                                        10000, 12000, 14000, 16000, 18000,
                                        24000 }, new double [] { 0, 0, 0.1,
                                        0.3, 0.7, 1, 1, 1, 1, 1, 1 }));
    ...
    public void testSlowdown () throws SoundTransformException {
        ...
        $.create (TransformSoundService.class, new PrintlnTransformObserver ())
                .transformFile (this.input, this.output,
                        $.create (SlowdownSoundTransformation.class, 200, 1.2f));
    ...
    public void testSpeedUp () throws SoundTransformException {
        ...
        $.create (TransformSoundService.class, new PrintlnTransformObserver ())
                .transformFile (this.input, this.output,
                        $.create (SpeedUpSoundTransformation.class, 200, 1.5f));
