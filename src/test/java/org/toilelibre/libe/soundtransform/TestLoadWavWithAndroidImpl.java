...
import org.toilelibre.libe.soundtransform.actions.fluent.FluentClientInterface;
...
public class TestLoadWavWithAndroidImpl extends SoundTransformAndroidTest {
    ...
    public void importCDHEader () throws SoundTransformException {
        ...
        final Sound [] sound = FluentClient.start ().withAudioInputStream (new ByteArrayInputStream (byteArray)).importToSound ().stopWithSounds ();
