...
public class LoudestFreqsTest {
    ...
    public void adjustFreqs () {
        ...
        final float [] result = FluentClient.start ().withFreqs (Arrays.asList (array)).adjust ().stopWithFreqs ().get (0);
    ...
    public void changeOctaveDown () {
        ...
        final float [] result = FluentClient.start ().withFreqs (Arrays.asList (array)).octaveDown ().stopWithFreqs ().get (0);
        org.junit.Assert.assertArrayEquals (result, array2, 0);
    }
    ...
    public void changeOctaveUp () {
        ...
        final float [] result = FluentClient.start ().withFreqs (Arrays.asList (array)).octaveUp ().stopWithFreqs ().get (0);
        org.junit.Assert.assertArrayEquals (result, array2, 0);
    }
    ...
    public void operationShouldBeReversibleEvenWithALotOfOctaveDown () {
        final float [] array = { 1, 2, 3, -2, -6, 10, 12 };
        final float [] result = FluentClient.start ().withFreqs (Arrays.asList (array)).octaveDown ().octaveDown ().octaveDown ().octaveDown ().octaveDown ().octaveUp ().octaveUp ().octaveUp ().octaveUp ().octaveUp ().stopWithFreqs ().get (0);
