...
@PrepareForTest ({ ApplicationInjector.class, LineListenerPlayObjectProcessor.class })
public class JavaxPlayObjectProcessorTest extends SoundTransformTest {

    @Rule
    public PowerMockRule                    rule = new PowerMockRule ();

    @InjectMocks
    private LineListenerPlayObjectProcessor processor;
    ...
    private LineListener [] mockNecessaryClasses (final Clip clip) throws InterruptedException {
        ...
        PowerMockito.when (ApplicationInjector.$.select (PlayObjectProcessor.class)).thenReturn (this.processor);
        MemberModifier.stub (MemberMatcher.method (LineListenerPlayObjectProcessor.class, "getLine", Info.class)).toReturn (clip);
        return ll;
    }
}
