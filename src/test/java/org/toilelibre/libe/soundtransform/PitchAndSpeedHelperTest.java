...
public class PitchAndSpeedHelperTest {
    ...
    public void shouldBeTwiceTheF0ValuePiano3e () throws SoundTransformException {
        ...
        final AudioInputStream ais = (AudioInputStream) new ConvertAudioFileService ().callConverter (input);
        ...
        final InputStream ais2 = ts.toStream (e4, new AudioFormatParser ().fromAudioFormat (ais.getFormat (), (int) ais.getFormat ().getSampleRate ()));
