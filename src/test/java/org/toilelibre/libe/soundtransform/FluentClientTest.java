...
public class FluentClientTest extends SoundTransformTest {
    ...
    public void replacePart() throws SoundTransformException {
        FluentClient.start().withClasspathResource("before.wav").convertIntoSound().apply(new ReplacePartSoundTransformation(FluentClient.start().withClasspathResource("before.wav").convertIntoSound().extractSubSound(600000, 700000).stopWithSounds(), 100000)).exportToClasspathResource("after.wav");
    }
