...
public class FluentClientTest extends SoundTransformTest {
    ...
    public void canAskToDoALotOfThingsToTheFluentClientOperationAndNothingShouldBeDone () throws SoundTransformException {
        ...
        .inParallel (null, 0, new File ("")).mixAllInOneSound ().andAfterStart ().inParallel (null, 0, Collections.singletonList (new float [0])).andAfterStart ().inParallel (null, 0, new ByteArrayInputStream (new byte [0])).andAfterStart ().inParallel (null, 0, new Sound [0]).andAfterStart ().inParallel (null, 0, "")
