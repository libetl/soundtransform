        ...
        PowerMockito.mockStatic(System.class, new Answer<Object> (){
            ...
            public Object answer(InvocationOnMock invocation) throws Throwable {
                return !invocation.getMethod ().getName ().equals ("getProperty") ||
                        !invocation.getArgumentAt(0, String.class).equals(ApplicationInjector.RUNTIME_SYSTEM_PROPERTY) ?
                                invocation.callRealMethod() : "Not a real runtime";
            }
    ...
    public void testAndroid (){
        PowerMockito.mockStatic(System.class, new Answer<Object> (){
            ...
            public Object answer(InvocationOnMock invocation) throws Throwable {
                return !invocation.getMethod ().getName ().equals ("getProperty") ||
                        !invocation.getArgumentAt(0, String.class).equals(ApplicationInjector.RUNTIME_SYSTEM_PROPERTY) ?
                                invocation.callRealMethod() : "The Android Project";
            }
