...
public class ViewSpectrumIDETest {
    ...
    public void viewC3 () throws SoundTransformException {
        final Chart chart = this.getChart (new String [] { "C3 (260Hz)" }, FluentClient.start ().withClasspathResource ("piano1c.wav").convertIntoSound ().splitIntoSpectrums ().stopWithSpectrums ().get (0) [0]);
        new SwingWrapper (chart).displayChart ();
    }

    @Test
    public void viewD3 () throws SoundTransformException {
        final Chart chart = this.getChart (new String [] { "D3 (293Hz)" }, FluentClient.start ().withClasspathResource ("piano2d.wav").convertIntoSound ().splitIntoSpectrums ().stopWithSpectrums ().get (0) [0]);
        new SwingWrapper (chart).displayChart ();
    }

    @Test
    public void viewE3 () throws SoundTransformException {
        final Chart chart = this.getChart (new String [] { "E3 (329Hz)" }, FluentClient.start ().withClasspathResource ("piano3e.wav").convertIntoSound ().splitIntoSpectrums ().stopWithSpectrums ().get (0) [0]);
        new SwingWrapper (chart).displayChart ();
    }
    ...
    public void viewG3 () throws SoundTransformException {
        final Chart chart = this.getChart (new String [] { "G3 (391Hz)" }, FluentClient.start ().withClasspathResource ("piano5g.wav").convertIntoSound ().apply (new LevelSoundTransform (100)).apply (new NormalizeSoundTransform (1)).splitIntoSpectrums ().stopWithSpectrums ().get (0) [0]);
        new SwingWrapper (chart).displayChart ();
    }

    @Test
    public void viewA4 () throws SoundTransformException {
        final Chart chart = this.getChart (new String [] { "A4 (440Hz)" }, FluentClient.start ().withClasspathResource ("piano6a.wav").convertIntoSound ().splitIntoSpectrums ().stopWithSpectrums ().get (0) [0]);
        new SwingWrapper (chart).displayChart ();
    }

    @Test
    public void viewB4 () throws SoundTransformException {
        final Chart chart = this.getChart (new String [] { "B4 (493Hz)" }, FluentClient.start ().withClasspathResource ("piano7b.wav").convertIntoSound ().splitIntoSpectrums ().stopWithSpectrums ().get (0) [0]);
        new SwingWrapper (chart).displayChart ();
    }

    @Test
    public void viewC4 () throws SoundTransformException {
        final Chart chart = this.getChart (new String [] { "C4 (523Hz)" }, FluentClient.start ().withClasspathResource ("piano8c.wav").convertIntoSound ().splitIntoSpectrums ().stopWithSpectrums ().get (0) [0]);
        new SwingWrapper (chart).displayChart ();
    }
