...
public class AudioFormatParserTest {
    ...
    public void testCDFormat () {
        InputStreamInfo isi = new InputStreamInfo (2, 0, 2, 44100.0, false,
                true);
        AudioFormat audioFormat = (AudioFormat) new WavAudioFormatParser ()
                .audioFormatfromInputStreamInfo (isi);
        InputStreamInfo isi2 = new WavAudioFormatParser ().fromAudioFormat (
                audioFormat, 0);
