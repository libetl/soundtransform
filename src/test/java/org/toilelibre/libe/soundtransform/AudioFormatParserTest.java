...
public class AudioFormatParserTest extends SoundTransformTest {
    ...
    public void testAudioFormatToIsi () {
        ...
        final Object isi2 = $.select (AudioFormatParser.class).audioFormatfromSoundInfo (audioFormat);
    ...
    public void testCDFormat () {
        ...
        final Object audioFormat = $.select (AudioFormatParser.class).audioFormatfromSoundInfo (isi);
