...
- [FluentClient](#fluentclient)
	...
	- [FluentClient Javadoc](#fluentclient-javadoc)
		- [1. static init](#1-static-init)
			- [FluentClient.setDefaultObserversValue](#fluentclientsetdefaultobserversvalue)
		- [2. start of the flow](#2-start-of-the-flow)
			- [FluentClient.start](#fluentclientstart-only-way-to-start-a-fluentclient)
			- [FluentClientReady.withAnObserver](#fluentclientreadywithanobserver-before-another-with-method)
			- [FluentClientReady.withAPack (Json InputStream)](#fluentclientreadywithapack-json-inputstream-before-another-with-method)
			- [FluentClientReady.withAPack (Android only)](#fluentclientreadywithapack-android-only-before-another-with-method)
			- [FluentClientReady.withAPack (Json String)](#fluentclientreadywithapack-json-string-before-another-with-method)
			- [FluentClientReady.withAudioInputStream](#fluentclientreadywithaudioinputstream-just-after-start)
			- [FluentClientReady.withClasspathResource](#fluentclientreadywithclasspathresource-just-after-start)
			- [FluentClientReady.withFile](#fluentclientreadywithfile-just-after-start)
			- [FluentClientReady.withFreqs](#fluentclientreadywithfreqs-just-after-start)
			- [FluentClientReady.withLimitedTimeRecordedInputStream](#fluentclientreadywithlimitedtimerecordedinputstream-just-after-start)
			- [FluentClientReady.withRawInputStream](#fluentclientreadywithrawinputstream-just-after-start)
			- [FluentClientReady.withRecordedInputStream](#fluentclientreadywithrecordedinputstream-just-after-start)
			- [FluentClientReady.withSounds](#fluentclientreadywithsounds-just-after-start)
			- [FluentClientReady.withSpectrums](#fluentclientreadywithspectrums-just-after-start)
		- [3. operations](#3-operations)
			- [FluentClientWithFreqs.adjust](#fluentclientwithfreqsadjust)
			- [FluentClient*.andAfterStart](#fluentclientandafterstart)
			- [FluentClientSoundImported.append](#fluentclientsoundimportedappend)
			- [FluentClientSoundImported.apply](#fluentclientsoundimportedapply)
			- [FluentClientSoundImported.changeFormat](#fluentclientsoundimportedchangeformat)
			- [FluentClientWithFreqs.compress](#fluentclientwithfreqscompress)
			- [FluentClientWithFile.convertIntoSound](#fluentclientwithfileconvertintosound)
			- [FluentClientSoundImported.cutSubSound](#fluentclientsoundimportedcutsubsound)
			- [FluentClientSoundImported.exportToClasspathResource](#fluentclientsoundimportedexporttoclasspathresource)
			- [FluentClientSoundImported.exportToClasspathResourceWithSiblingResource](#fluentclientsoundimportedexporttoclasspathresourcewithsiblingresource)
			- [FluentClientSoundImported.exportToFile](#fluentclientsoundimportedexporttofile)
			- [FluentClientSoundImported.exportToStream](#fluentclientsoundimportedexporttostream)
			- [FluentClientWithSpectrums.extractSound](#fluentclientwithspectrumsextractsound)
			- [FluentClientSoundImported.extractSubSound](#fluentclientsoundimportedextractsubsound)
			- [FluentClientWithFreqs.filterRange](#fluentclientwithfreqsfilterrange)
			- [FluentClientSoundImported.findLoudestFrequencies](#fluentclientsoundimportedfindloudestfrequencies)
			- [FluentClientWithInputStream.importToSound](#fluentclientwithinputstreamimporttosound)
			- [FluentClientWithFile.importToStream](#fluentclientwithfileimporttostream)
			- [FluentClientWithFreqs.insertPart](#fluentclientwithfreqsinsertpart)
			- [FluentClientSoundImported.loop](#fluentclientsoundimportedloop)
			- [FluentClientSoundImported.mixWith](#fluentclientsoundimportedmixwith)
			- [FluentClientWithFreqs.octaveDown](#fluentclientwithfreqsoctavedown)
			- [FluentClientWithFreqs.octaveUp](#fluentclientwithfreqsoctaveup)
			- [FluentClientSoundImported.playIt or FluentClientWithFile.playIt or FluentClientWithInputStream.playIt or FluentClientWithSpectrums.playIt](#fluentclientsoundimportedplayit-or-fluentclientwithfileplayit-or-fluentclientwithinputstreamplayit-or-fluentclientwithspectrumsplayit)
			- [FluentClientWithFreqs.replacePart](#fluentclientwithfreqsreplacepart)
			- [FluentClientWithFreqs.shapeIntoSound](#fluentclientwithfreqsshapeintosound)
			- [FluentClientSoundImported.splitIntoSpectrums](#fluentclientsoundimportedsplitintospectrums)
			- [FluentClientWithInputStream.writeToClasspathResource](#fluentclientwithinputstreamwritetoclasspathresource)
			- [FluentClientWithInputStream.writeToClasspathResourceWithSiblingResource](#fluentclientwithinputstreamwritetoclasspathresourcewithsiblingresource)
			- [FluentClientWithInputStream.writeToFile](#fluentclientwithinputstreamwritetofile)
		- [4. method flow stops](#4-method-flow-stops)
			- [FluentClient*.stopWithAPack](#fluentclientstopwithapack)
			- [FluentClientWithFile.stopWithFile](#fluentclientwithfilestopwithfile)
			- [FluentClientWithFreqs.stopWithFreqs](#fluentclientwithfreqsstopwithfreqs)
			- [FluentClientWithInputStream.stopWithInputStream](#fluentclientwithinputstreamstopwithinputstream)
			- [FluentClient*.stopWithObservers](#fluentclientstopwithobservers)
			- [FluentClientSoundImported.stopWithSounds](#fluentclientsoundimportedstopwithsounds)
			- [FluentClientWithSpectrums.stopWithSpectrums](#fluentclientwithspectrumsstopwithspectrums)
			- [FluentClientWithInputStream.stopWithStreamInfo](#fluentclientwithinputstreamstopwithstreaminfo)
